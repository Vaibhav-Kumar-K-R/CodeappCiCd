        ...
        <div onClick={handleClickOutside} className="flex flex-grow flex-col">
            <div className="view-title flex justify-between">
                ...
                <div className="flex gap-2">
                    <button
                        className="hover:bg-darkHover rounded-md px-1"
...
function Directory({
    ...
    return (
        <div className="overflow-x-auto">
            <div
                className="hover:bg-darkHover flex w-full items-center rounded-md px-2 py-1"
...
const FileMenu = ({
    ...
    return (
        <div
            className="border-darkHover bg-dark absolute z-10 w-[150px] rounded-md border p-1"
            style={{
                top,
                left,
            }}
        >
            <button
                ...
                className="hover:bg-darkHover flex w-full items-center gap-2 rounded-md px-2 py-1"
            >
            ...
            <button
                ...
                className="hover:bg-darkHover flex w-full items-center gap-2 rounded-md px-2 py-1 text-danger"
            >
                <MdDelete size={20} />
                Delete
            </button>
